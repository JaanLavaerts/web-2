...
<main>
    ...
    <section>
        ...
        <div class="alert">
            ...
            <form method="POST" action="Servlet?command=updatevalues" novalidate>
                <p class="form-group ${statusNaam}">
                <label for="naam">
                    Naam*
                    <input readonly id="naam" name="naam" type="text" placeholder="Naam van de show..." value="${show.naam}">
                </label>
                </p>
                <p class="form-group ${statusScore}">
                <label for="score">
                    Score*
                    <input type="number" id="score" name="score" min="0" max="10" placeholder="Score tussen 0 en 10..." required value="${show.score}">
                </label>
                </p>
                ...
                <label for="uitgekeken">
                    ...
                    <select id="uitgekeken" name="uitgekeken">
                        <option value=""> -- </option>
                        <c:if test="${show.uitgekeken eq 'Ja'}">
                            <option selected value="Ja">Ja</option>
                            <option value="Nee">Nee</option>
                        </c:if>
                        <c:if test="${show.uitgekeken eq 'Nee'}">
